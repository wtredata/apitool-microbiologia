...
@section('content')
    <body class="overflow-x-hidden p-0 m-0">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item active" id='li_sidebar_bienvenida'>
                            <a class="sidebar-link btnEvent" data-event='click' data-route='SeeSection_Bienvenido'
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" class="feather feather-home align-middle mr-2">
                        ...
                        @if ($rol_usuario == 1 || $rol_usuario == 5)
                            <li class="sidebar-item" id='li_sidebar_administracion'>
                                <a class="sidebar-link btnEvent" data-event='click' data-route='SeeSection_Configuracion'
                                    data-menu_item_select='#li_sidebar_administracion' href="#">
                        ...
                        <li class="sidebar-item" id='li_sidebar_resultados'>
                            <a class="sidebar-link btnEvent" data-event='click' data-route='SeeSection_Resultado'
                                data-temporal_off="true" data-menu_item_select='#li_sidebar_resultados' href="#">
                        ...
                        <li class="sidebar-item" id='li_sidebar_resultados_cualitativos'>
                            <a class="sidebar-link btnEvent" data-event='click'
                                data-route='SeeSection_ResultadoCualitativo' data-temporal_off="true"
                                data-menu_item_select='#li_sidebar_resultados_cualitativos' href="#">
                        ...
                        <li class="sidebar-item" id='li_sidebar_microbiologia'>
                            <a class="sidebar-link btnEvent" data-event='click' data-route='#' data-temporal_off="true"
                                data-menu_item_select='#li_sidebar_microbiologia' href="#"
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="sidebar-item" id='li_sidebar_resultados_microbiologia'>
                                    <!----<a class="sidebar-link btnEvent" data-event='click' data-route='SeeSection_ResultadoMicrobiologia'
                                        data-temporal_off="true"
                                        data-menu_item_select='#li_sidebar_resultados_microbiologia' href="#">---->
                                    <a class="sidebar-link btnEvent" href="{{ route('microbiologia.medios') }}">
                                        ...
                                        <span class="align-middle">Resultados Medios de cultivo</span>
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-item" id='li_sidebar_resultados_pruebas'>
                                    <a class="sidebar-link btnEvent" href="{{ route('microbiologia.pruebas') }}">
                                        ...
                                        <span class="align-middle">Resultados Pruebas de sensibilidad</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item" id='li_sidebar_uroanalisis'>
                            <a class="sidebar-link btnEvent" data-event='click'
                                data-route='SeeSection_ResultadoCualitativo' data-temporal_off="true"
                                data-menu_item_select='#li_sidebar_uroanalisis' href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="feather feather-grid align-middle mr-2">
                        ...
                        <li class="sidebar-item" id="li_sidebar_grafica">
                            <a class="sidebar-link btnEvent" data-event="click" data-route="SeeSection_GraficaIntegrada"
                        ...
                        <li class="sidebar-item" id="li_sidebar_sigmometria">
                            <a class="sidebar-link btnEvent" data-event="click" data-route="SeeSection_Sigmometria"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="feather feather-git-merge align-middle mr-2">
                        ...
                        @if ($rol_usuario == 1 || $rol_usuario == 2 || $rol_usuario == 5)
                            <li class="sidebar-item" id='li_sidebar_comparativa_laboratorio'>
                                <a class="sidebar-link btnEvent" data-event="click"
                                    data-route="SeeSection_ComparativaInterlaboratorio" data-temporal_off='true'
                        ...
                        @if ($rol_usuario == 1 || $rol_usuario == 2 || $rol_usuario == 5)
                            <li class="sidebar-item" id='li_sidebar_auditoria'>
                                <a class="sidebar-link btnEvent" data-event="click" data-route="SeeSection_Auditoria"
                                    data-temporal_off='false' data-menu_item_select='#li_sidebar_auditoria'
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-shield align-middle mr-2">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-icon dropdown-toggle d-inline-block d-sm-none" href="#"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="feather feather-settings align-middle mr-2">
                                            <circle cx="12" cy="12" r="3"></circle>
                                            <path
                                                d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z">
                                            </path>
                                    ...
                                    <a class="nav-link nav-link-user dropdown-toggle d-none d-sm-inline-block"
                                        href="#" data-toggle="dropdown">
                                        <span class='icono-perfil'
                                            style='background:#{{ $color_hexadecimal }};'>{{ $iniciales }}</span>
                                        <span class="text-dark nombres_usuario">{{ explode(' ', $nombres)[0] }}
                                            {{ explode(' ', $apellidos)[0] }}</span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item disabled" href="#">
                                            ...
                                            <strong>Rol:</strong> {{ $nom_rol_usuario }}
                                        </a>

                                        <div class="dropdown-divider"></div>

                                        <a class="dropdown-item" href="{{ route('logout.get') }}">Cerrar sesión</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="feather feather-phone align-middle mr-2">
                                            <path
        ...
        <div class="modal fade right overflow-auto overflow-x-hidden" data-backdrop="true" id="panel-lateral-analitos"
            ...
            <div class="modal-dialog modal-full-height modal-right modal-notify" role="document">
                <div class="modal-content">
                    <div class="modal-header align-items-center">
                        ...
                        <a href="{{ route('downloadTree') }}" class="btn btn-outline-primary waves-effect"
                            style="padding: 5px;" target="_blank">Descargar</a>
