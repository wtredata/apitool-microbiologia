...
@section('content')
            ...
            <div class="sidebar-content js-simplebar sticky-top pr-0 m-0">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item" id='li_sidebar_resultados_cualitativos'>
                        <a class="sidebar-link btnEvent" data-event='click' data-route='SeeSection_ResultadoCualitativo'
                           data-temporal_off="true"
        ...
        <div class="modal-dialog modal-full-height modal-right modal-notify" role="document">
            <div class="modal-content">
                <div class="modal-header align-items-center">
                    ...
                    <a href="{{route('downloadTree')}}" class="btn btn-outline-primary waves-effect" style="padding: 5px;" target="_blank">Descargar</a>
    ...
    <script
        src="{{ asset('js/analitoLaboratorio/informacionValoresEstadisticos.js?v_beta') }}"></script>
