...
@section('content')
    ...
    <body>
        <div class="container">
            <div class="header">
                <img src="{{ public_path('img/banner-APITool.jpg') }}" alt="Logo awalí">
                <h1>CONTROL DE CALIDAD DE PRUEBAS DE SENSIBILIDAD</h1>
            </div>
                ...
                <table class="tabla-principal">
                    <thead>
                        <tr>
                            ...
                            <td class="text-center"><strong>Antibiótico</strong></td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="text-center">{{ $fechaActual }}</td>
                            <td class="text-center">{{ $Antibiotico }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
