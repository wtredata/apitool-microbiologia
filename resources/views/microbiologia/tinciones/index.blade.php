            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h3>Agregar Tincion</h3>
                        <p>Relacione el lote de una tincion a un laboratorio existente.</p>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="row align-items-end">
                                        <div class="col-12 col-md-12 mb-2 mb-sm-0">
                                            <label for="loteTincionId">Tincion</label>
                                            <select class="form-control" name="loteTincionId" id="loteTincionId">
                                                @foreach ($lotesTinciones as $lote)
                                                    @foreach ($lote->tinciones as $tincion)
                                                        <option value="{{ $lote->id }}">Lote: {{ $lote->lote }} |
                                                            Tinción:
                                                            {{ $tincion->nom_tincion }}</option>
                                                    @endforeach
                                                @endforeach
                                            </select>
                                        </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>Encuentre los lotes de tinciones relacionados a cada laboratorio.</p>
                    </div>
                    <div class="card-body">
                        <div id="tree">
                        </div>
            ...
            $("#tree").fancytree({
                ...
                click: function(event, data) {
                    if(data.node.data.id !== undefined && data.node.children.length === 0){
                        window.location.href = '/microbiologia/detalleTincion/' + data.node.data.id;
                    }
                }
            });
        });
