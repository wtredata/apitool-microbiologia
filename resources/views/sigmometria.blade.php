    ...
    <div class="row px-3">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="form-group">
                ...
                <input type="date" class="form-control btnEvent height-input" id="sigmometria-f-inicial" value="{{ $fecha_inicial }}"
        ...
        <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="form-group">
                ...
                <input type="date" class="form-control btnEvent height-input" id="sigmometria-f-final" value="{{ $fecha_final }}"
                       data-event="change" data-route="ActualizarModuloSigmometria">
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-md-8 mb-3">
            ...
            <div class="contenedor-graficos-sigmometria" id='cont_grafica_sigmometria'>
                <div class="presentacion-graficos bg-white">
                    <img src="{{ asset('img/sixsigma.png') }}" alt="gráfica de sigmometria" class='icono-presentacion'>
