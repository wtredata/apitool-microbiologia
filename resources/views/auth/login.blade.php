...
<body class="overflow-auto">
            ...
            <div class="container">
                <div class="row wow fadeIn">
                    <div class="col-md-6 mb-4 white-text text-center text-md-left">
                        <img src="{{ asset('img/logoAPIT.png') }}" alt="logo de APITool" width='582' class='mb-2'>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="">
                                            <label for="nom_usuario" class="form-label">{{ __('Nombre de usuario') }}</label>
                                            <input id="nom_usuario" type="nom_usuario"
                                                autocomplete="off"
                                                class="form-control form-control-lg @error('nom_usuario') is-invalid @enderror"
                                                name="nom_usuario"
                                                value="{{ old('nom_usuario') }}" required autocomplete="nom_usuario"
                                                autofocus>
    ...
    <script src="{{ asset('js/modules/wow.js?v_beta') }}"></script>
