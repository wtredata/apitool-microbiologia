    ...
    <div class="modal-dialog" style='max-width: 600px !important;'>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary font-weight-bold">
                <p class="heading lead m-0 text-white">Actualización de contraseña para <strong>{{ $usuario->nom_usuario }}</strong></p>
            ...
            <form class="form formEvent formCreate" data-route="Store_UsuarioPass" data-event="submit" data-close_modal='true'>
                <div class="modal-body">
                    ...
                    <input type="hidden" value='{{ $usuario->id_usuario }}' name='id_usuario' id='usuario_pass_act'>
