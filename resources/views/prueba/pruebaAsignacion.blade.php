<div class="modal SeeSectionPrueba" tabindex="-1" id='prueba-modal'>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary font-weight-bold">
                <p class="heading lead m-0 text-white">Configuración de pruebas de sensibilidad</p>
                <button class="btnEvent close" data-event='click' data-route='CancelModal' data-preguntaantes="false"
                    data-modalselected='#prueba-modal'>
            ...
            <div class="modal-body">
                ...
                <div class="col-sm-12 col-lg-4 mb-2">
                        @include("prueba.pruebaAsociacion")
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light btn-sm btnEvent" data-event='click' data-route='CancelModal'
                    data-modalselected='#prueba-modal' data-preguntaantes="false">Cerrar</button>
            </div>
        </div>
    </div>
</div>