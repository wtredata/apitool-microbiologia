<form class="form formEvent formCreate" data-route="Store_PruebaLaboratorio" data-event="submit" data-tables_liged="Prueba">
    ...
    <div class="form-outline mb-4">
        <div class="row">
            <div class="col-12">
                <label class="form-label font-weight-bold" for="control_lab_prueba">Prueba de sensibilidad</label>
                <select id="control_lab_prueba" class='form-control prueba' name='prueba'></select>
            </div>
            <div class="col-12 contMessage contMessage_prueba"></div>
        </div>
    </div>
