    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary font-weight-bold">
                <p class="heading lead m-0 text-white">Analitos de {{ $control_laboratorio->cod_lote }} - {{ $control_laboratorio->nom_control }} - {{ $control_laboratorio->fecha_vencimiento }}</p>
            ...
            <div class="modal-body">
                <div class="row pt-2">
                    <div class="col-sm-12 col-lg-3 mb-2">
                        @include("analitoLaboratorio.analitoLaboratorioCreate")
                    </div>

                    <div class="col-sm-12 col-lg-9 mb-2 border-left overflow-auto Cont_Table_AnalitoLaboratorio">
                        @include("analitoLaboratorio.analitoLaboratorioIndex")
                    </div>
                </div>
            </div>
