...
class PDFEstadisticoCualitativo extends \Codedge\Fpdf\Fpdf\Fpdf {
    ...
    public function generarContenido($defecto_cualitativo, $resultado, $data, $grafica2, $control_laboratorio, $laboratorio, $fecha_inicial, $fecha_final)
    {
