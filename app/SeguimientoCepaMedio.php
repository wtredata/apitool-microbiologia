...
class SeguimientoCepaMedio extends Model
{
    protected $table = "seguimiento_cepas_medio";
    protected $fillable = ['id', 'lote_cepa_id', 'lote_medio_id'];
    use HasFactory;

    public function comentariosLoteMedio()
    {
        return $this->hasMany(ControlCepaMedio::class, 'seguimiento_cepa_id', 'id');
    }
    ...
    public function loteLaboratorio()
    {
        return $this->hasOneThrough(
            ...
            'lote_medio_id', // Local key on SeguimientoCepaMedio table
