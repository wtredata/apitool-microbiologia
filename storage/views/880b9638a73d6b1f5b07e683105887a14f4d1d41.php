<div class="row <?php echo e($nomSection); ?> m-0 mt-4">
    <div class="col-12">
        <div class="row">
            <div class="col">
                            ...
                            <div class="row w-100 m-0" style="gap:0.5rem 1rem;">
                                <div class="form-group col-12 col-sm-5 col-md-3 col-lg-2 m-0 p-0 select2-width">
                                    ...
                                    <select style="min-width: 10rem;" name="laboratorio"
                                        ...
                                        <?php $__currentLoopData = $laboratorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laboratorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option><?php echo e($laboratorio->num_laboratorio); ?></option>
                                ...
                                <div class="form-group col-12 col-sm-6 col-md-4 col-lg-3 m-0 p-0 select2-width">
                                    ...
                                    <select
                                        ...
                                        <?php $__currentLoopData = $acciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value='<?php echo e($accion->id_titulo); ?>'><?php echo e($accion->nom_titulo); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="form-group col-12 col-sm-5 col-md-3 col-lg-2 m-0 p-0">
                                    ...
                                    <input class='form-control inputDateSingle btnEvent height-input w-100'
                                           ...
                                           type="text" value='<?php echo e($fecha_inicial); ?>'>
                                </div>
                                ...
                                <div class="form-group col-12 col-sm-6 col-md-3 col-lg-2 m-0 p-0">
                                    ...
                                    <input class='form-control inputDateSingle btnEvent height-input w-100'
                                           ...
                                           type="text" value='<?php echo e($fecha_final); ?>'>
                                </div>
...
<?php /**PATH /var/www/html/resources/views/auditoria/auditoriaSection.blade.php ENDPATH**/ ?>