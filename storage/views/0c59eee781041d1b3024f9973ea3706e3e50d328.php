<div class="row SeeSectionSede m-0 mt-4">
    ...
    <div class="col-lg-4">
        <div class="card shadow mb-3 bg-transparent shadow shadow-sm border">
            ...
            <div class="card-body">
                <?php echo $__env->make("sede.sedeCreate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow mb-4 bg-transparent shadow shadow-sm border">
            ...
            <div class="card-body">
                <div class="Cont_Table_Sede overflow-auto">
                    <?php echo $__env->make("sede.sedeIndex", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH /var/www/html/resources/views/sede/sedeSection.blade.php ENDPATH**/ ?>