        ...
        <div class="row">
            <div class="col">
                <select name="sede" class="form-control form-control-sm sede laboratorioSedeAssigned btnEvent notClear" id='laboratorio_sede_reference' data-event="change" data-route="SeeIndex_Laboratorio" data-tables_liged="Laboratorio" data-objjson='{"id": "laboratorio_sede_reference"}'>
                    <?php $__currentLoopData = $sedesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</form><?php /**PATH /var/www/html/resources/views/laboratorio/laboratorioCreate.blade.php ENDPATH**/ ?>