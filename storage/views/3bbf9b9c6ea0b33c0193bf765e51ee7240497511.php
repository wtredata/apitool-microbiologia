<div class="row SeeSectionMatriz m-0 mt-4">
    ...
    <div class="col-lg-4">
        <div class="card shadow mb-3 bg-transparent shadow shadow-sm border">
            ...
            <div class="card-body">
                <?php echo $__env->make("matriz.matrizCreate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow mb-4 bg-transparent shadow shadow-sm border">
            ...
            <div class="card-body">
                <div class="Cont_Table_Matriz overflow-auto">
                    <?php echo $__env->make("matriz.matrizIndex", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH /var/www/html/resources/views/matriz/matrizSection.blade.php ENDPATH**/ ?>