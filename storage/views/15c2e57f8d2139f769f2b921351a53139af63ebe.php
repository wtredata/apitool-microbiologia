...
<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar">
            <div class="sidebar-content js-simplebar sticky-top pr-0 m-0">
                <a class="sidebar-brand brand " href="<?php echo e(route('home')); ?>">
                    <img src="<?php echo e(asset('img/banner-APITool.jpg')); ?>" alt="Logo principal"
                ...
                <ul class="sidebar-nav">
                    ...
                    <?php if($rol_usuario == 1): ?>
                        <li class="sidebar-item" id='li_sidebar_administracion'>
                            <a class="sidebar-link btnEvent" data-event='click'
                               data-route='SeeSection_Configuracion'
                               data-menu_item_select='#li_sidebar_administracion'
                               href="#">
                    ...
                    <li class="sidebar-item" id='li_sidebar_resultados'>
                        <a class="sidebar-link btnEvent" data-event='click' data-route='SeeSection_Resultado'
                           data-temporal_off="true"
                           data-menu_item_select='#li_sidebar_resultados' href="#">
                    ...
                    <li class="sidebar-item" id="li_sidebar_grafica">
                        <a class="sidebar-link btnEvent" data-event="click"
                           data-route="SeeSection_GraficaIntegrada"
                           data-temporal_off='true' data-menu_item_select='#li_sidebar_grafica' href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none"
                                 stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                 stroke-linejoin="round"
                    ...
                    <li class="sidebar-item" id="li_sidebar_sigmometria">
                        <a class="sidebar-link btnEvent" data-event="click" data-route="SeeSection_Sigmometria"
                           data-temporal_off='true' data-menu_item_select='#li_sidebar_sigmometria' href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <?php if($rol_usuario == 1 || $rol_usuario == 2 || $rol_usuario == 5): ?>
                        <li class="sidebar-item" id='li_sidebar_comparativa_laboratorio'>
                            <a class="sidebar-link btnEvent" data-event="click"
                               data-route="SeeSection_ComparativaInterlaboratorio"
                               data-temporal_off='true'
                               data-menu_item_select='#li_sidebar_comparativa_laboratorio' href="#">
                    ...
                    <?php if($rol_usuario == 1 || $rol_usuario == 2 || $rol_usuario == 5): ?>
                        <li class="sidebar-item" id='li_sidebar_auditoria'>
                            <a class="sidebar-link btnEvent" data-event="click" data-route="SeeSection_Auditoria"
                               data-temporal_off='false' data-menu_item_select='#li_sidebar_auditoria' href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="main overflow-none">
                        ...
                        <ul class="navbar-nav navbar-align">
                            <li class="nav-item dropdown">
                                ...
                                <span class='icono-perfil'
                                      style='background:#<?php echo e($color_hexadecimal); ?>;'><?php echo e($iniciales); ?></span>
                                    <span class="text-dark nombres_usuario"><?php echo e(explode(" ", $nombres)[0]); ?>

                                        <?php echo e(explode(" ", $apellidos)[0]); ?></span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item disabled" href="#">
                                        ...
                                        <strong>Rol:</strong> <?php echo e($nom_rol_usuario); ?>
            ...
            <main class="content overflow-hidden w-100" id="containerMax">
                <?php echo $__env->make("bienvenido", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </main>
                            ...
                            <p class="mb-0">
                                <a href="https://quik.com.co" rel="noopener" target='_blank'
                                   class="text-muted"><strong>Copyright
                                        &copy;
                                        Quik S.A.S. - Quality is the key 2020 - <?php echo e(date("Y")); ?></strong></a>
                            </p>
                        </div>
    ...
    <div class="modal fade right overflow-auto overflow-x-hidden"
         data-backdrop="true" id="panel-lateral-analitos" tabindex="-1"
         role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-full-height modal-right modal-notify" role="document">
            <div class="modal-content">
                <div class="modal-header align-items-center">
                    <p class="heading lead text-dark">Lista de analitos
                    </p>
    ...
    <div id="sectionModalsD"></div>

    <script src="<?php echo e(asset('js/jquery.min.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/jquery-ui/jquery-ui.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/jquery.dataTables.min.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/moment.min.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/daterangepicker.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/select2.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/sweetalert2.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/toastr.min.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/jquery.fancytree.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/jquery.contextMenu.min.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/jquery.fancytree.contextMenu.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery/jquery-textrange.js?v_beta')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/complementos/addFilaTable.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/eliminarModal.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/gestionEnvioForm.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/impresionError.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/indexLoad.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/indexLoadAsignation.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/inputDates.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/obtenerFechasFiltro.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/presenteContinuo.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/resaltarAprobacion.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/show.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/tablaDinamica.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/nomLegibleSection.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/switchSelect2.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/switchSeeSection.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/switchDinamicModal.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/abrirAnalito.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/dinamicModal.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/descCampGet.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/recargarSegmentoFancyTree.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/middlewareEvent.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/switchIndexLoad.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/navegacionResultados.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/agregarFilaResultados.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/generarNovedadResultados.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/guardarResultados.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/validacionResultados.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/eventoCierreInesperado.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/switchDestroy.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/asignarPredeterminado.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/switchUpdate.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/menuAnalitos.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/seeSection.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/seeList.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/seeListLite.js?v_beta')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/complementos/saveAsignacion.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/generarModuloSigmometria.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/generarConsensoSigmometria.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/generarTablaSigmometria.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/generarInfoControlSigmometria.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/gestionErroresBackend.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/complementos/alertaVencimientoLote.js?v_beta')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/graficos/generarGraficaIntegrada.js?v_beta')); ?>"></script>
    ...
    <script
        src="<?php echo e(asset('js/analitoLaboratorio/informacionValoresEstadisticos.js?v_beta')); ?>"></script>
    <script src="<?php echo e(asset('js/home.js?v_beta')); ?>"></script>
    </body>
