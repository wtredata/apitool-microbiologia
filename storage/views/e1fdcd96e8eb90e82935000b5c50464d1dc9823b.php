        ...
        <div class="row">
            <div class="col">
                <select name="rol" class="form-control form-control-sm pais btnEvent notClear">
                    ...
                    <?php $__currentLoopData = $rolesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</form><?php /**PATH /var/www/html/resources/views/usuario/usuarioCreate.blade.php ENDPATH**/ ?>