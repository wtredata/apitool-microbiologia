<div class="row SeeSectionBienvenido">
    ...
    <div class="view">
        ...
        <div class="cont-img-presentacion-bienvenido d-flex">
            <!--<img src="<?php echo e(asset('img/banner-APITool.jpg')); ?>" alt="banner de presentación Quik - API Tool" class='img-presentacion-bienvenido d-none d-sm-none d-md-block'>
            <img src="<?php echo e(asset('img/logo-APITool.png')); ?>" alt="banner de presentación Quik - API Tool" class='img-presentacion-bienvenido d-block d-sm-block d-md-none'>-->

                <div class="p-2">
                    <img src="<?php echo e(asset('img/banner-APITool.jpg')); ?>" alt="banner de presentación Quik - API Tool"
            ...
            <div class="container">
                ...
                <div class="row d-flex h-100 justify-content-center align-items-center wow fadeIn animated"
                    ...
                    <div class="col-md-6 mb-4 text-center text-md-left pr-4 p-md-2">
                        ...
                        <h1 class="display-6 text-center font-weight-bold">¡Hola, <?php echo e(explode(" ", $nombres)[0]); ?>!
                        </h1>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <img src="<?php echo e(asset('img/responsive-design.jpg')); ?>" alt="Gráfico de presentación" width='300'
...
<?php /**PATH /var/www/html/resources/views/bienvenido.blade.php ENDPATH**/ ?>