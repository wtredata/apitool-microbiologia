            ...
            <div class="contenedor-detalle-sigmometria overflow-auto">
                <div id="mesurandos_table" class="cont-tabla-analitos overflow-auto" style='max-height:600px;'>
                    <table class='table table-sm table-bordered text-center table-info-siget'>
                        ...
                        <tbody>
                        <?php $__currentLoopData = $datos_reporte["labels"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="width: 100%">
                                ...
                                <?php elseif($constante_z <= round($data["sigma"], 2) && round($data["sigma"], 2) < 3 ): ?>
                                    <td colspan='1'
                                        style="background-color: #C2D3FFFF;"><?php echo e(round($data["sigma"], 2)); ?></td>
                                <?php elseif($constante_z > round($data["sigma"], 2)): ?>
                                    <td colspan='1'
...
<div>
    ...
    <div class="<?php echo e($nomSection); ?>" id="<?php echo e($nomSection); ?>">
        ...
        <script type="application/javascript">
            data_reporte_r = <?php echo json_encode($datos_reporte, JSON_HEX_TAG); ?>;
            datos_conteo_metrica_r = <?php echo json_encode($datos_conteo_metrica, JSON_HEX_TAG); ?>;
            constante_z = <?php echo json_encode($constante_z, JSON_HEX_TAG); ?>;
            max_sigma_r = <?php echo json_encode($max_sigma, JSON_HEX_TAG); ?>;
            min_sigma_r = <?php echo json_encode($min_sigma, JSON_HEX_TAG); ?>;
...
<div>
    ...
    <div class="<?php echo e($nomSection); ?>" id="$nomSection">
        ...
        <script>
            ...
            data_error = <?php echo json_encode($datos_reporte, JSON_HEX_TAG); ?>;
            filters = <?php echo json_encode($data_of_filters, JSON_HEX_TAG); ?>;
            ...
            label.forEach(
                label => {
                    ...
                    cv.push(label.cv);
                    cvmp.push(label.cv_mp);
                    sesgo.push(label.sesgo);
                    sesp.push(label.sesgo_por);
                    x.push("Numero analito: " + label.indice + "\nSede: " + label.sede + "\nAnalito: " + label.analito);
                }
            );
...
<?php /**PATH /var/www/html/resources/views/comparativo-interlaboratorio/reporte.blade.php ENDPATH**/ ?>