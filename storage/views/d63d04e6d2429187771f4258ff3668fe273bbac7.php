<form class="form formEvent formCreate" data-route="Store_AnalitoLaboratorio" data-event="submit"
    ...
    <input type="hidden" id='analito_lab_control_laboratorio' class='notClear' value='<?php echo e($control_laboratorio->id_control_laboratorio); ?>' name='control_laboratorio'>
...
</form><?php /**PATH /var/www/html/resources/views/analitoLaboratorio/analitoLaboratorioCreate.blade.php ENDPATH**/ ?>